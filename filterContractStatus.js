...
function filterContractStatus_updateData(w) {
  return w;
}

function filterContractStatus_cssStyle(w) {
  var widget = $("#" + w.general.renderTo);

  let width = 0; // Ширина выпадающего списка виджета. Если 0 - остается неизменна
  let height = 0; // Высота выпадающего списка виджета. Если 0 - остается неизменна
  var listPosition = "right"; // Выравнивание выпадающего списка right или left
